...
TARGET_KERNEL_SOURCE := kernel/iuni/sultan
...
# Assert
TARGET_OTA_ASSERT_DEVICE := u3,U3,NBL8910A,nbl8910a
...
# Recovery
TARGET_RECOVERY_FSTAB := $(PLATFORM_PATH)/rootdir/etc/fstab.u3

# Releasetools
TARGET_RECOVERY_UPDATER_LIBS := librecovery_updater_u3
